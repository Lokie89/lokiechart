...
public class UpbitCandleService implements CandleService {
    ...
    public CandleResponses get5MinutesCandles(String market, int candleCount, LocalDateTime to) {
        return minuteCandleRepository.getCandles(UpbitMinuteCandleParameter.builder().market(market).candleMinute(CandleMinute.FIVE).count(candleCount).to(to).build());
    }
    ...
    public CandleResponses get15MinutesCandles(String market, int candleCount, LocalDateTime to) {
        return minuteCandleRepository.getCandles(UpbitMinuteCandleParameter.builder().market(market).candleMinute(CandleMinute.FIFTEEN).count(candleCount).to(to).build());
    }
    ...
    @Override
    public CandleResponses getMinuteCandles(CandleMinute candleMinute, String market, int candleCount) {
        return minuteCandleRepository.getCandles(UpbitMinuteCandleParameter.builder().market(market).candleMinute(candleMinute).count(candleCount).build());
    }

    @Override
    public CandleResponses getMinuteCandles(CandleMinute candleMinute, String market, int candleCount, LocalDateTime to) {
        return minuteCandleRepository.getCandles(UpbitMinuteCandleParameter.builder().market(market).candleMinute(candleMinute).count(candleCount).to(to).build());
    }
}
