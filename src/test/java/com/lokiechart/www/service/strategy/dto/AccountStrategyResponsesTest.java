...
class AccountStrategyResponsesTest {
    ...
    void setUp() {
        ...
        AccountStrategyResponse tjdfhrBuyStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdfhr.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(buy, buy5, buy15)))).build();
        AccountStrategyResponse tjdfhrSellStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdfhr.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(sell1)))).build();
        AccountStrategyResponse tjdalsBuyStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdals.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(buy5)))).build();
        AccountStrategyResponse tjdalsSellStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdals.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(sell1)))).build();
        AccountStrategyResponse tjdfhr2BuyStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdfhr.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(buy15)))).build();
        AccountStrategyResponse tjdfhr2SellStrategyResponse = AccountStrategyResponse.builder().accountResponse(tjdfhr.build()).orderStrategies(new OrderStrategies(new HashSet<>(Arrays.asList(sell1)))).build();
